...
urlpatterns = [
    path('sessao/', include(SessaoCrud.get_urls() + OradorCrud.get_urls() +
    ...
    re_path(r'^sessao/(?P<pk>\d+)/correspondencia-em-lote', CorrespondenciaEmLoteView.as_view(),
        name='correspondencia_em_lote'),

    path('sessao/<int:pk>/mesa', MesaView.as_view(), name='mesa'),

    path('sessao/mesa/atualizar-mesa/',
        atualizar_mesa,
        name='atualizar_mesa'),

    path('sessao/mesa/insere-parlamentar/composicao/',
        insere_parlamentar_composicao,
        name='insere_parlamentar_composicao'),

    path('sessao/mesa/remove-parlamentar-composicao/',
        remove_parlamentar_composicao,
    ...
    re_path(r'^sessao/filtra-materias-copia-sessao-ajax/',
        filtra_materias_copia_sessao_ajax,
        name='filtra_materias_copia_sessao_ajax_view'),
    re_path(r'^sessao/verifica-materia-sessao-plenaria-ajax/',
        verifica_materia_sessao_plenaria_ajax,
        name='verifica_materia_sessao_plenaria_ajax_view'),

    path('sessao/<int:pk>/<int:spk>/abrir-votacao',
        abrir_votacao,
        name="abrir_votacao"),

    re_path(r'^sessao/(?P<pk>\d+)/reordena/(?P<tipo>[\w\-]+)/(?P<ordenacao>\d+)/$',
        reordena_materias, name="reordena_materias"),

    path('sistema/sessao-plenaria/tipo/',
        include(TipoSessaoCrud.get_urls())),
    path('sistema/sessao-plenaria/tipo-resultado-votacao/',
        include(TipoResultadoVotacaoCrud.get_urls())),
    path('sistema/sessao-plenaria/tipo-expediente/',
        include(TipoExpedienteCrud.get_urls())),
    path('sistema/sessao-plenaria/tipo-justificativa/',
        include(TipoJustificativaCrud.get_urls())),
    path('sistema/sessao-plenaria/tipo-retirada-pauta/',
        include(TipoRetiradaPautaCrud.get_urls())),
    path('sistema/bancada/',
        include(BancadaCrud.get_urls())),
    path('sistema/cargo-bancada/',
    ...
    path('sessao/<int:pk>/matexp/leitura/<int:oid>/<int:mid>',
        ExpedienteLeituraView.as_view(), name='leituraexp'),
    path('sessao/<int:pk>/matordemdia/leitura/<int:oid>/<int:mid>',
        OrdemDiaLeituraView.as_view(), name='leituraod'),

    path('sessao/<int:pk>/<int:iso>/<int:oid>/retirar-leitura',
        retirar_leitura, name='retirar_leitura'),

    path('sessao/<int:pk>/transf-mat-exp',
        TransferenciaMateriasExpediente.as_view(),
        name="transf_mat_exp"),
    path('sessao/<int:pk>/transf-mat-ordemdia',
