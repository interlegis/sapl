...
urlpatterns = [
    ...
    re_path(r'^sessao/(?P<pk>\d+)/consideracoes_finais$',
    ...
    re_path(r'^sessao/(?P<pk>\d+)/leitura_bloco_expediente$',
        LeituraEmBlocoExpediente.as_view(),
        name='leitura_bloco_expediente'),
    re_path(r'^sessao/(?P<pk>\d+)/leitura_bloco_ordem_dia$',
    ...
    re_path(r'^sessao/(?P<pk>\d+)/transf-mat-exp$',
        TransferenciaMateriasExpediente.as_view(),
        name="transf_mat_exp"),
    re_path(r'^sessao/(?P<pk>\d+)/transf-mat-ordemdia$',
