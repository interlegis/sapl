...
from sapl.sessao.views import (
    ...
    TipoSessaoCrud,
    TransferenciaMateriasExpediente,
...
urlpatterns = [
    ...
    url(r"^sessao/mesa/atualizar-mesa/$", atualizar_mesa, name="atualizar_mesa"),
    url(
    ...
    url(r"^sistema/sessao-plenaria/tipo/", include(TipoSessaoCrud.get_urls())),
    url(
    ...
    url(r"^sistema/bancada/", include(BancadaCrud.get_urls())),
    ...
    # PAUTA SESSÃO
    url(r"^sessao/pauta-sessao$", PautaSessaoView.as_view(), name="pauta_sessao"),
    url(
    ...
    url(
        r"^sessao/(?P<pk>\d+)/consideracoes_finais$",
        ConsideracoesFinaisView.as_view(),
        name="consideracoes_finais",
    ),
    url(r"^sessao/(?P<pk>\d+)/presenca$", PresencaView.as_view(), name="presenca"),
    url(r"^sessao/(?P<pk>\d+)/painel$", PainelView.as_view(), name="painel"),
    url(
    ...
    url(
        r"^sessao/(?P<pk>\d+)/leitura_bloco_expediente$",
        LeituraEmBlocoExpediente.as_view(),
        name="leitura_bloco_expediente",
    ),
    url(
        r"^sessao/(?P<pk>\d+)/leitura_bloco_ordem_dia$",
        LeituraEmBlocoOrdemDia.as_view(),
        name="leitura_bloco_ordem_dia",
    ),
    url(r"^sessao/(?P<pk>\d+)/resumo$", ResumoView.as_view(), name="resumo"),
    url(r"^sessao/(?P<pk>\d+)/resumo_ata$", ResumoAtaView.as_view(), name="resumo_ata"),
    url(
    ...
    url(
        r"^sessao/(?P<pk>\d+)/transf-mat-exp$",
        TransferenciaMateriasExpediente.as_view(),
        name="transf_mat_exp",
    ),
    url(
        r"^sessao/(?P<pk>\d+)/transf-mat-ordemdia$",
