    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.PositiveIntegerField(choices=[(
                1, 'Simbólica'), (2, 'Nominal'), (3, 'Secreta')], verbose_name='Tipo de votação'),
        ),
        migrations.AlterField(
            model_name='orador',
            name='numero_ordem',
            field=models.PositiveIntegerField(
                verbose_name='Ordem de pronunciamento'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.FileField(
                blank=True, upload_to=sapl.sessao.models.ata_upload_path, null=True, verbose_name='Ata da Sessão'),
        ),
        migrations.AlterField(
            model_name='sessaoplenaria',
            name='upload_pauta',
            field=models.FileField(
                blank=True, upload_to=sapl.sessao.models.pauta_upload_path, null=True, verbose_name='Pauta da Sessão'),
        ),
        migrations.AlterField(
