...
class SessaoPlenaria(models.Model):
    ...
    status_cronometro_aparte = models.CharField(
        max_length=1,
        verbose_name=_('Status do cronômetro aparte'),
        default='S')
    status_cronometro_ordem_do_dia = models.CharField(
        max_length=1,
        verbose_name=_('Status do cronômetro ordem do dia'),
        default='S')
    status_cronometro_consideracoes_finais = models.CharField(
        max_length=1,
        verbose_name=_('Status do cronômetro consideracoes finais'),
        default='S')
    status_cronometro_personalizado = models.CharField(
        max_length=1,
        verbose_name=_('Status do cronômetro personalizado'),
        default='S')
