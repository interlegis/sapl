...
class SessaoPlenaria(models.Model):
    ...
    correspondencias = models.ManyToManyField(
        ...
        through_fields=("sessao_plenaria", "documento"),
    )
...
class OcorrenciaSessao(models.Model):  # OcorrenciaSessaoPlenaria
    sessao_plenaria = models.OneToOneField(SessaoPlenaria, on_delete=models.PROTECT)
...
class TipoResultadoVotacao(models.Model):
    NATUREZA_CHOICES = Choices(
        ("A", "aprovado", "Aprovado"), ("R", "rejeitado", "Rejeitado")
    )
...
class ResumoOrdenacao(models.Model):
    ...
    decimo_quinto = models.CharField(max_length=50, default=ORDENACAO_RESUMO[14][0])
    decimo_sexto = models.CharField(max_length=50, default=ORDENACAO_RESUMO[15][0])
...
class Correspondencia(models.Model):
    ...
    tipo = models.PositiveIntegerField(
        verbose_name=_("Tipo da Correspondência"), choices=TIPO_CHOICES, default=1
    )
