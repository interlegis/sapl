...
urlpatterns = [
    path("painel-principal/<int:pk>", painel_view, name="painel_principal"),
    ...
    path("painel/parlamentar", painel_parlamentar_view, name="painel_parlamentar"),
    ...
    path("voto-individual/", votante_view, name="voto_individual"),
]
