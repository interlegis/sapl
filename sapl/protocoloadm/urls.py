...
urlpatterns_documento_administrativo = [
    ...
    url(
        r"^docadm/texto_integral/(?P<pk>\d+)$",
        doc_texto_integral,
    ...
    url(
        r"^docadm/documentoacessorioadministrativo/pdf/(?P<pk>\d+)$",
        get_pdf_docacessorios,
...
urlpatterns_protocolo = [
    ...
    url(r"^protocoloadm/$", ProtocoloPesquisaView.as_view(), name="protocolo"),
    url(
