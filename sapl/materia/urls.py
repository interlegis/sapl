...
urlpatterns_materia = [
    ...
    re_path(r'^materia/docacessorio/zip/(?P<pk>\d+)$', get_zip_docacessorios,
        name='compress_docacessorios'),
    re_path(r'^materia/docacessorio/pdf/(?P<pk>\d+)$', get_pdf_docacessorios,
...
urlpatterns_proposicao = [
    ...
    re_path(r'^proposicao/texto/(?P<pk>\d+)$', proposicao_texto,
...
urlpatterns_sistema = [
    ...
    re_path(r'^sistema/materia/status-tramitacao/', include(
