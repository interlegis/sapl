...
class MateriaLegislativa(models.Model):
    ...
    polemica = models.BooleanField(
        null=True, blank=True, default=False, verbose_name=_("Matéria Polêmica?")
    )
    objeto = models.CharField(max_length=150, blank=True, verbose_name=_("Objeto"))
    complementar = models.BooleanField(
        null=True, blank=True, default=False, verbose_name=_("É Complementar?")
    )
        ...
        if self.ano and self.numero_protocolo:
            ...
            if protocolo:
                if protocolo.timestamp:
                    ...
                    return tz.localize(datetime.combine(protocolo.data, protocolo.hora))
                elif protocolo.data:
...
class Tramitacao(models.Model):
    TURNO_CHOICES = Choices(
        ...
        (
            "E",
            "primeira_segunda_votacao_urgencia",
