...
from sapl.crispy_layout_mixin import (CrispyLayoutFormMixin, SaplFormHelper,
                                      get_field_display)
...
class ListWithSearchForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            Field("o"),
            FieldWithButtons(
                Field("q", placeholder=_("Filtrar Lista"), css_class="form-control-lg"),
                StrictButton(
...
class CrudListView(PermissionRequiredContainerCrudMixin, ListView):
    ...
    def _as_row(self, obj):
        ...
        for i, (name, func) in enumerate(
            self._parse_field_names(self.list_field_names)
        ):
        ...
        try:
            ...
            return [
                (
                    ...
                    else getattr(self.object, obj.model_set)
                    .model._meta.get_field(fieldname)
...
class MasterDetailCrud(Crud):
    ...
    class BaseMixin(Crud.BaseMixin):
        ...
        def get_context_data(self, **kwargs):
            ...
            title = (
                "%s <small>(%s)</small>" % (self.object, parent_object)
                if parent_object
                else ""
            )
