...
urlpatterns = [
    path(r'^ta/', include(urlpatterns_compilacao)),

    path(r'^sistema/ta/config/tipo-nota/',
        include(TipoNotaCrud.get_urls())),
    path(r'^sistema/ta/config/tipo-vide/',
        include(TipoVideCrud.get_urls())),
    path(r'^sistema/ta/config/tipo-publicacao/',
        include(TipoPublicacaoCrud.get_urls())),
    path(r'^sistema/ta/config/veiculo-publicacao/',
        include(VeiculoPublicacaoCrud.get_urls())),
    path(r'^sistema/ta/config/tipo/',
        include(TipoTextoArticuladoCrud.get_urls())),
    path(r'^sistema/ta/config/tipodispositivo/',
