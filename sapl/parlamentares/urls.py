...
urlpatterns = [
    ...
    url(
        r"^parlamentar/(?P<pk>\d+)/normas$",
        ParlamentarNormasView.as_view(),
        name="parlamentar_normas",
    ),
    url(
        r"^parlamentar/(?P<pk>\d+)/frentes/$",
        get_parlamentar_frentes,
    ...
    url(r"^sistema/parlamentar/legislatura/", include(LegislaturaCrud.get_urls())),
    url(
    ...
    url(r"^sistema/parlamentar/tipo-militar/", include(TipoMilitarCrud.get_urls())),
    ...
    url(r"^sistema/mesa-diretora/cargo-mesa/", include(CargoMesaCrud.get_urls())),
    url(r"^mesa-diretora/$", MesaDiretoraView.as_view(), name="mesa_diretora"),
    url(
