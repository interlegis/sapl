...
urlpatterns = [
    path(r'^relatorios/materia$', relatorio_materia, name='relatorio_materia'),
    path(r'^relatorios/capa-processo$',
        relatorio_capa_processo, name='relatorio_capa_processo'),
    path(r'^relatorios/ordem-dia$', relatorio_ordem_dia,
        name='relatorio_ordem_dia'),
    path(r'^relatorios/relatorio-documento-administrativo$',
    ...
    path(r'^relatorios/(?P<pk>\d+)/sessao-plenaria$',
        relatorio_sessao_plenaria, name='relatorio_sessao_plenaria'),

    path(r'^relatorios/protocolo$',
        relatorio_protocolo, name='relatorio_protocolo'),
    path(r'^relatorios/(?P<nro>\d+)/(?P<ano>\d+)/etiqueta-protocolo$',
